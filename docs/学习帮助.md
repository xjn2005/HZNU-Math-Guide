...
如果部分链接无法访问，请先阅读这篇[飞书文档](https://uufyjevghz.feishu.cn/docx/DP78d2U5TosTOTx9QCbcjp8GnBh)中的相关说明。
...
8. [数据分析资料库](https://larkcommunity.feishu.cn/wiki/T3TXwE2VXi9FBUk5ywockbPhnBb) 一个飞书的优质知识库，里面较为系统地梳理了数据分析知识。
...
6. [HuggingFace](https://huggingface.co/) 全球开源 AI 模型与工具平台。
7. [Gitee](https://gitee.com/) 国内开源平台。
8. [少数派](https://sspai.com/?utm_source=itab.ink) 知名社区。
9. [稀土掘金](https://juejin.cn/) 知名开发社区。
10. [Reddit](https://www.reddit.com/) 国际网络社区。
11. [Top.AI](https://topd.tencent.com/ai?ref=itab.link) 腾讯的开放设计平台。
12. [豆瓣](https://www.douban.com/) 文艺青年聚集地。 

## 实用网站

1. [excalidraw](https://excalidraw.com/) 手绘风画图工具。
2. [draw.io](https://app.diagrams.net/) 在线绘图网站。
3. [Anna's Archive](https://zh.annas-archive.gl/) 全世界最大的在线图书馆，我个人感觉比 zlib 更好用。
4. [carbon](https://carbon.now.sh/?bg=rgba%28171%2C184%2C195%2C100%29&t=seti&wt=none&l=auto&width=680&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=48px&ph=32px&ln=false&fl=1&fm=Hack&fs=13px&lh=133%25&si=false&es=2x&wm=false&code=) 代码块美化工具。
5. [uTools](https://www.u-tools.cn/index.html?from=itab) 优质插件集合。
6. [oeis](https://oeis.org/?language=chineseS) 整数数列大全。
7. [geogebra desmos](https://www.desmos.com/calculator?lang=zh-CN) 解析几何画图工具。
8. [软站](https://rzhan.cc/) 软件集合。
9. [BlogFinder](https://bf.zzxworld.com/s) 搜集个人 Blog 的网站。
10. [SQLZoo](https://sqlzoo.net/wiki/SQL_Tutorial) 在线练习 SQL 语句。
11. [Hello GitHub](https://hellogithub.com/) 介绍 GitHub 里面优质项目的网站。
12. [How to cook](https://cook.aiursoft.com) 教你如何烹饪的指南。
13. [BentoPDF](https://bentopdf.com/) PDF 工具箱。
14. [TinyPng](https://tinypng.com/) 压缩png的网站。
...
2. 使用电脑上的笔记软件。飞书、语雀、思源、FlowUs、ima、Notion、Obsidian、Typora 等都可以。如果你使用 macOS，也可以尝试 [妙言](https://miaoyan.app/)。
3. 可以通过 [keybr](https://www.keybr.com/) 练习盲打。
4. 虽然对于数学专业来说不是必须，但仍然强烈建议学习 [Git](https://git-scm.com/book/zh/v2/%E8%B5%B7%E6%AD%A5-%E5%AE%89%E8%A3%85-Git)。
...
如果少数派页面允许访问，直接阅读这篇文章会更稳定：

[日常工作学习流 - 少数派](https://sspai.com/post/75969)

但我**不建议**没有前端基础的同学直接折腾 Obsidian。
